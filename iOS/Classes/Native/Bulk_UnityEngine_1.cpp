...
extern Il2CppClass* Physics2D_t2540166467_il2cpp_TypeInfo_var;
extern const uint32_t Physics2D_RaycastAll_m1130550216_MetadataUsageId;
extern "C"  RaycastHit2DU5BU5D_t4176517891* Physics2D_RaycastAll_m1130550216 (Il2CppObject * __this /* static, unused */, Vector2_t2243707579  ___origin0, Vector2_t2243707579  ___direction1, const MethodInfo* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (Physics2D_RaycastAll_m1130550216_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	float V_0 = 0.0f;
	float V_1 = 0.0f;
	int32_t V_2 = 0;
	float V_3 = 0.0f;
	RaycastHit2DU5BU5D_t4176517891* V_4 = NULL;
	{
		V_0 = (std::numeric_limits<float>::infinity());
		V_1 = (-std::numeric_limits<float>::infinity());
		V_2 = ((int32_t)-5);
...
IL_002a:
	{
		RaycastHit2DU5BU5D_t4176517891* L_5 = V_4;
		return L_5;
	}
}
